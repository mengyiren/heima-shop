...
import type { InputNumberBoxEvent } from '@/types/vk-data-goods-sku-popup'
...
const onDeleteCart = async (val: string) => {
  await deleteMemberCartAPI({ ids: [val] })
  //重新获取列表数据
  getCartData()
}
...
const onChangeSelectedAll = () => {
  ...
  putMemberCartSelectAllAPI({ selected: _isSelectedAll })
}
